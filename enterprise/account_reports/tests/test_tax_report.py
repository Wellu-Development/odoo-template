...
class TestTaxReport(TestAccountReportsCommon):
    ...
    def test_only_one_closing_entry_per_fpos(self):
        ...
        self.assertEqual(domestic_closing_move, domestic_closing_move, "The domestic closing entry should be the one used for the basic tax report.")
        self.assertEqual(other_country_closing_move, other_country_closing_move, "The foreign closing entry should be the one used for the other country tax report.")
        self.assertEqual(generic_closing_move_domestic.tax_closing_report_id, self.basic_tax_report, "The domestic closing entry should be linked to the generic tax report.")
